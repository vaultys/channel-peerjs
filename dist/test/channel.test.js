...
describe("PeerjsChannel tests", () => {
    it("Start and stop", async () => {
        ...
        expect(manager2.getContact(manager1.vaultysId.did)?.fingerprint).to.equal(manager1.vaultysId.fingerprint);
        ...
        expect(manager1.getContactMetadata(manager2.vaultysId.did, "name")).to.equal("salut");
        expect(manager1.getContactMetadata(manager2.vaultysId.did, "group")).to.equal("pro");
